...
const (
	...
	APIUserAgent = "Kraken GO API Agent (https://github.com/sergey-lipin/kraken-go-api-client)"
)
...
func (api *KrakenAPI) queryPublic(reqURL string, values url.Values, typ interface{}) (interface{}, error) {
